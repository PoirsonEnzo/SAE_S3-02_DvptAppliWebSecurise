...
class SupprimerFavorisAction extends Action
{
    public function getResult(): string
    {
        ...
        if (!isset($_SESSION['profil']['id_profil'])) {
            return "<div class='favoris'><p>impossible de supprimer des favoris : Aucun profil de sélectionné.</p></div>";
        }
        ...
        if (!$check->fetch()) {
            return "<div class='favoris'><p>Cette série n'est pas dans vos favoris.</p>
        ...
        return "<div class='favoris'><p>Série supprimée de vos favoris !</p>
                <p><a href='?action=AfficherSerie&id={$idSerie}'>Retour à la série</a></p></div>";
    }
}
